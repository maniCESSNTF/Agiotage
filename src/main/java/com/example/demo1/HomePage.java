...
//        try {
//            FXMLLoader loader = new FXMLLoader(getClass().getResource("AvalanchPage.fxml"));
//            Parent mainView = loader.load();
//
//            AvalanchPage avalanchPage = loader.getController();
//            avalanchPage.setClient(client, thisUsername);
//
...
//        try {
//            FXMLLoader loader = new FXMLLoader(getClass().getResource("DayPage.fxml"));
//            Parent mainView = loader.load();
//
//            Day day = loader.getController();
//            day.setClient(client, thisUsername);
//
//            Scene scene = new Scene(mainView);
//            Stage primaryStage = (Stage) btnprofile.getScene().getWindow();
//            primaryStage.setScene(scene);
...
//        try {
//            FXMLLoader loader = new FXMLLoader(getClass().getResource("LightcoinPage.fxml"));
//            Parent mainView = loader.load();
//
//            Lightcoin lightcoin = loader.getController();
//            lightcoin.setClient(client, thisUsername);
//
//            Scene scene = new Scene(mainView);
//            Stage primaryStage = (Stage) btnprofile.getScene().getWindow();
//            primaryStage.setScene(scene);
...
//        try {
//            FXMLLoader loader = new FXMLLoader(getClass().getResource("RippelPage.fxml"));
//            Parent mainView = loader.load();
//
//            RippelPage rippelPage = loader.getController();
//            rippelPage.setClient(client, thisUsername);
//
//            Scene scene = new Scene(mainView);
//            Stage primaryStage = (Stage) btnprofile.getScene().getWindow();
//            primaryStage.setScene(scene);
...
//        try {
//            FXMLLoader loader = new FXMLLoader(getClass().getResource("StellarPage.fxml"));
//            Parent mainView = loader.load();
//
//            StellarCoin stellarCoin = loader.getController();
//            stellarCoin.setClient(client, thisUsername);
//
//            Scene scene = new Scene(mainView);
//            Stage primaryStage = (Stage) btnprofile.getScene().getWindow();
//            primaryStage.setScene(scene);
...
////        timeline = new Timeline(new KeyFrame(Duration.seconds(10), event -> updateTime()));
...
//        double roundedNumber = Double.valueOf(df.format(number));
    ...
    public void initialize() {
        ...
        // ایجاد تایم لاین برای به روزرسانی زمان هر 1 ثانیه
        timeline = new Timeline(new KeyFrame(Duration.seconds(60), event -> updateTime()));
        timeline.setCycleCount(Animation.INDEFINITE); // تنظیم برای اجرا به صورت نامحدود
        timeline.play(); // شروع تایم لاین
    }
}