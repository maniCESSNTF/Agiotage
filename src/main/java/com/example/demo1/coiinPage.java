...
public class coiinPage {
    ...
    @FXML
    void Pbtnavalanche(ActionEvent event) {

    }

    @FXML
    void Pbtnday(ActionEvent event) {

    }

    @FXML
    void Pbtnlightcoin(ActionEvent event) {
    ...
    @FXML
    void Pbtnstellar(ActionEvent event) {
