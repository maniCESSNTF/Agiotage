...
//    public ImageView imgCaptchaCodeWthdrawal;
    ...
    @FXML
    private Text txtxrippelWallet;

    @FXML
    private Text txtavalancheWallet;


    @FXML
    private Text txtlightcoinWallet;


    @FXML
    private Text txtldayWallet;

    @FXML
    private Text txtlStellsrWallet;

    @FXML
    private Text txtmoneywallet;
...
//                                            method(money1,thisUsername,money2,usernameBefore,newMoneyAmount);
    ...
    public void initialize() {
        ...
        tabWallet.selectedProperty().addListener((observable, oldValue, newValue) -> {
            if (newValue) {
                try (Connection connection = DriverManager.getConnection("jdbc:mysql://localhost:3306/agiotage2", "root", "")) {
                    String sql = "SELECT * FROM signin WHERE username = ?";
                    try (PreparedStatement statement = connection.prepareStatement(sql)) {
                        ...
                        if (resultSet.next()) {
                            ...
                            txtlightcoinWallet.setText(String.valueOf(resultSet.getInt("lightcoin")));
                            txtldayWallet.setText(String.valueOf(resultSet.getInt("day")));
                            txtlStellsrWallet.setText(String.valueOf(resultSet.getInt("stellar")));
                            txtavalancheWallet.setText(String.valueOf(resultSet.getInt("avalanche")));
                            txtxrippelWallet.setText(String.valueOf(resultSet.getInt("rippel")));
                            txtmoneywallet.setText(String.valueOf(resultSet.getInt("money")));
