...
public class AvalanchPage {
    ...
    void initialize() throws SQLException {
        ...
        txtNowPrice.setText(String.valueOf(Double.valueOf(df.format(eur))));
        txtPercentage.setText(String.valueOf(Double.valueOf(df.format(((eur - eur24) / eur) * 100))));
...
//        txtVolume-----------------------------------------------------حجم معاملات
        ...
        updateTime(); // زمان را به روزرسانی کنید
    }
